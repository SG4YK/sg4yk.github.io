...
在网页偏又下的地方有一个Textarea，左边显示的内容原封不动地敲进去即可过关。  
...
;
~~~
在Console中直接执行<code>text22InChange()</code>即可过关。  
...
题目数量不少，你想靠我的数学知识全部写出正确答案基本是在做梦，因为后面有一些不做人的题目:
